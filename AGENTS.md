...
地下管网知识模型数据库是基于 LangGraph v1、Vue 3、FastAPI、Milvus、Neo4j 与 PostGIS 的智能体平台，覆盖 RAG、显式图谱检索、可迁移知识库和空间分析。项目通过 Docker Compose 管理；开发 Web 支持热重载，isolated Web 使用预构建的 web/dist。
