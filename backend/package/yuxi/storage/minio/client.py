...
class MinIOClient:
    ...
    def upload_file_from_path(
        ...
        try:
            ...
            return UploadResult(f"http://{self.public_endpoint}/{bucket_name}/{object_name}", bucket_name, object_name)
    ...
    def download_file_to_path(self, bucket_name: str, object_name: str, file_path: str) -> None:
        """将对象直接下载到文件，避免大文件进入进程内存。"""
        try:
