      ...
      <main class="hero-section">
        <div class="hero-layout">
          <div class="hero-content reveal-up">
            <p class="hero-kicker">Agent · RAG · Knowledge Graph · Spatial Data</p>
        ...
        <section class="capability-grid reveal-up delay-2" aria-label="平台能力">
...
const capabilities = [
  { title: '智能体', description: '面向业务任务的多轮协作与工具调用', icon: Bot },
  { title: '知识库', description: '文档解析、向量检索与权限隔离', icon: Library },
  { title: '图谱增强检索', description: '显式查询实体、关系与关联证据', icon: GitFork },
  { title: '知识库迁移', description: '安全导入导出应用层迁移包', icon: DatabaseBackup },
  { title: '空间数据', description: '图层管理、叠加展示与派生分析', icon: Map },
  { title: 'MCP', description: '接入可治理的外部工具与服务', icon: Plug },
  { title: 'Skills', description: '复用专业工作流与领域能力', icon: Boxes }
]
...
.capability-card {
  ...
  background: color-mix(in srgb, var(--main-0) 88%, transparent);
...
@import '@/assets/css/home-template.less';
</style>
