...
import KnowledgeGraphResult from './renderers/KnowledgeGraphResult.vue'
import SpatialMapResult from './renderers/SpatialMapResult.vue'
...
const TOOL_RENDERERS = {
  ...
  show_spatial_map: SpatialMapResult,
  task: TaskTool,
