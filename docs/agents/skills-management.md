...
系统会自动：
- 校验 ZIP 内容和路径安全性，并限制文件数量、单文件大小、解压总大小和压缩比
- 拒绝路径穿越、绝对路径、可执行二进制、未知大二进制和隐藏敏感文件
- 允许脚本文件随 Skill 上传，但会在安装草稿中标记脚本风险
...
5. 点击“解析并确认”，系统返回安装草稿；阅读高风险说明、勾选“我已理解上述风险”，再确认共享范围并点击“确认风险并安装”
