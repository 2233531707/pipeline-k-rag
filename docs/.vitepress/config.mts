...
export default defineConfig({
  lang: 'zh-CN',
  title: '地下管网知识模型数据库',
  description: '企业知识图谱、RAG 与空间智能体平台',
  base: '/pipeline-k-rag/',
  lastUpdated: false,
  ignoreDeadLinks: [
    /localhost/,
  ...
  themeConfig: {
    ...
    nav: [
      ...
      { text: 'Main2.0 能力', link: '/features/main2-capabilities' },
    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: '项目结构', link: '/develop-guides/project-structure' },
          { text: 'Main2.0 路线图', link: '/development/main2-roadmap' },
    ...
    socialLinks: [
      { icon: 'github', link: 'https://github.com/2233531707/pipeline-k-rag' }
    ],

    footer: {
      message: '本项目基于 MIT License 开源，欢迎使用和贡献。',
      copyright: 'Copyright © 2026 地下管网知识模型数据库'
    },

    editLink: {
      pattern: 'https://github.com/2233531707/pipeline-k-rag/edit/main/docs/:path',
      text: '在 GitHub 上编辑此页'
    },
